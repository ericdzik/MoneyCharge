    ...
    return ThemeData(
      ...
      chipTheme: ChipThemeData(
        ...
        secondaryLabelStyle: AppTextStyles.caption.copyWith(
          color: AppColors.onPrimary, // Texte blanc pour les chips sélectionnés
          fontWeight: FontWeight.w600,
        ),
        shape: const StadiumBorder(),
        padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
        // Couleur de l'icône pour les chips sélectionnés
        iconTheme: const IconThemeData(
          color:
              AppColors.onPrimary, // Icône blanche pour les chips sélectionnés
        ),
      ),
      ...
      textTheme: TextTheme(
        ...
        titleSmall: AppTextStyles.body2.copyWith(
          color: AppColors.textPrimary,
          fontWeight: FontWeight.w500,
        ),
